...
class DistributionInboxResource extends JsonResource
{
    /**
    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            "project"=>$this->project ? [
                "id"=>$this->project?->id,"name"=>json_decode($this->project?->name),
                "wbs"=>[
            ...
            'action' => CustomOptionSummaryResource::make($this->action[0]),
            'subject'   => $this->type=="form"?json_decode($this->subject):$this->subject,
            "contact" => UserContactSummaryResource::collection($this->contacts),
