...
class CanDeleteModuleAssignFormException extends Exception implements IApplicationException
{
    public function __construct(array $formNames = [], int $code = HttpStatusCodeEnum::UNAUTHORIZED)
    {
        $message = trans('validation.messages.cannot_delete_module_has_forms', [
